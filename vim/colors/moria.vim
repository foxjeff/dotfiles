...
if &background == "dark"
    if s:moria_style == "darkslategray"
        ...
        hi StatusLine ctermfg=8 guibg=#507070 guifg=fg gui=bold
				"hi StatusLineNC ctermbg=8 ctermfg=0 guibg=#406060 guifg=fg gui=none
        hi StatusLineNC ctermbg=2 ctermfg=8 guibg=#406060 guifg=fg gui=none
        ...
        elseif s:moria_style == "black"
            hi Normal ctermbg=0 ctermfg=7 guibg=#000000 guifg=#dddddd gui=none
    ...
    "hi Comment guibg=bg guifg=#999999 gui=none newer still
    hi Comment ctermfg=8 guibg=bg guifg=#999999 gui=none
