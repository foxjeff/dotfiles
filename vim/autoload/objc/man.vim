...
let s:docsets =  []
let locations = [
			\	{'path': '/Users/anand/Library/Developer/Shared/Documentation/DocSets/com.apple.adc.documentation.AppleLion.CoreReference.docset',
			\	'alias': 'Lion'},
			\	{'path': '/Users/anand/Library/Developer/Shared/Documentation/DocSets/com.apple.ADC_Reference_Library.DeveloperTools.4_3.docset',
			\	'alias': 'DevTools 4.3'},
			\	{'path': '/Users/anand/Library/Developer/Shared/Documentation/DocSets/com.apple.adc.documentation.AppleiOS5_1.iOSLibrary.docset',
			\	'alias': 'iPhone 5.1'}
			\	]
